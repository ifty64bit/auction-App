...
namespace assaginment_task
{
    public partial class buyer_info : Form
    {
        ...
        {
            if (string.IsNullOrEmpty(imgName) || string.IsNullOrEmpty(textBox2.Text) || string.IsNullOrEmpty(textBox1.Text) || string.IsNullOrEmpty(textBox3.Text) || string.IsNullOrEmpty(textBox4.Text))
            {
                MessageBox.Show("Enter All Input");
            }
            else
            {
